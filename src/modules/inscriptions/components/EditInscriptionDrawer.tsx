...
import { useUpdateInscription, type Inscription } from '../hooks/useInscriptions';
import { inscriptionFormSchema, type InscriptionFormData } from '../schemas/inscription.schema';
import { toInscriptionUpdate } from '../utils/inscriptionTransform';
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent className="max-h-[96vh] overflow-y-auto">
        <DrawerHeader>
          <DrawerTitle>Edit Inscription</DrawerTitle>
          <DrawerDescription>Update inscription information.</DrawerDescription>
        </DrawerHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 px-4">
            ...
            <DrawerFooter>
              <Button type="submit" disabled={isPending}>
                {isPending ? 'Updating...' : 'Update Inscription'}
              </Button>
              <Button
                type="button"
                variant="outline"
