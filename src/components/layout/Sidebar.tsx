      ...
      <div className="border-t border-gardens-sidebar-border p-2">
        ...
        >
          ...
          <div className="text-left">
            <div className="text-xs font-medium text-gardens-nav-on truncate max-w-[148px]">{profileName}</div>
            <div className="text-[10px] text-gardens-nav-off mt-px">{profileRole}</div>
          </div>
        </button>
      </div>
    </>
